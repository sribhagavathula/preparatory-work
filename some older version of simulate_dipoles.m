...
cfg.elec = elec64; % see above
cfg.dip.pos=dippos(rand_pos,:);
cfg.dip.mom= [x y z]'; % coordinate axes in which the dipole is aligned
                       % note, it should be transposed. 
  
cfg.dip.amplitude=amplitude; % Dipole amplitude between (0~3)
cfg.ntrials = 1;
cfg.triallength = 1;     % seconds
cfg.fsample = 250;   % Hz
% Check the source code
cfg.relnoise=N; % add noise to simulated data based on chosen SNR
cfg.absnoise=0; 
